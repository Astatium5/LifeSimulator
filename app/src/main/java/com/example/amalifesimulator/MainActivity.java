...
public class MainActivity extends AppCompatActivity {
    ...
    public void onNextButtonRoommate (View view) {
        setContentView(R.layout.layout_roommate);

        TextView semesterRoommateTextView = findViewById(R.id.semesterRoommateTextView);
        semesterRoommateTextView.setText("Semester " + semesterNumber);
    }
